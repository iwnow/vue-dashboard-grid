export const GridType = {
  ...
  /**
 * @returns {import("./grid").GridConfig}
 */
export function createGridConfigDefault() {
  return {
      ...
      draggable: {
        ...
        ignoreContentClass: 'dgrid-item-content', // default content class to ignore the drag event from
